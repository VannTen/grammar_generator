...
/*   Updated: 2017/11/07 11:36:52 by mgautier         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_symbol	**create_arithmetic_expr_grammar(void)
{
	t_symbol	**grammar;
	size_t		index;
	t_symbol	*(*init_func[])(void) = {create_expr, create_term, create_factor, create_integer, create_minus, create_plus, create_multiply, create_divide, NULL};
